  ...
  return (
    <div className="mt-2">
      ...
      <Button
        ...
        variant="outline"
        className={cn(
          'mt-2 h-10 w-full rounded-md border border-zinc-300 px-3 py-2 font-semibold placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring text-sm cursor-pointer hover:bg-blue-100 hover:text-teal-900 flex justify-center items-center gap-2',
          images.length >= 3
